...
//    Inc., 51 Franklin Street, Fifth Floor, Boston, MA  021-1301, USA.
// </copyright>
// --------------------------------------------------------------------------------------------------------------------
...
namespace DEHPEcosimPro.Tests.ViewModel
{
    ...
    public class DifferenceViewModelTestFixture
    {
        ...
        public void Verify()
        {
            ...
            this.parameter2.ValueSet.FirstOrDefault().ActualState = this.actualState1;
            ...
            this.parameter1.ValueSet.LastOrDefault().ActualState = null;
            this.parameter2.ValueSet.FirstOrDefault().ActualState = null;
            this.parameter2.ValueSet.LastOrDefault().ActualState = null;

            this.parameter1.StateDependence = null;
            this.parameter2.StateDependence = null;

            //add options
            this.parameter1.ValueSet.FirstOrDefault().ActualOption = this.option1;
            this.parameter1.ValueSet.LastOrDefault().ActualOption = this.option2;
            this.parameter2.ValueSet.FirstOrDefault().ActualOption = this.option1;
            this.parameter2.ValueSet.LastOrDefault().ActualOption = this.option2;
        ...
        {
            this.viewModel.Parameters = new ReactiveList<ParameterDifferenceRowViewModel>();
            this.viewModel.Parameters.Add(new ParameterDifferenceRowViewModel(new Parameter(), new Parameter(), "", "", "", "", ""));
