// --------------------------------------------------------------------------------------------------------------------
// <copyright file="OpcVariableChangedEvent.cs" company="RHEA System S.A.">
...
namespace DEHPEcosimPro.Events
{
    ...
    /// </summary>
    public class OpcVariableChangedEvent
    {
        /// <summary>
        /// The NodeId identifier of the <see cref="MonitoredItem"/>
        /// </summary>
        public object Id { get; set; }

        /// <summary>
        /// The <see cref="MonitoredItem"/> value
        /// </summary>
        public object Value { get; set; }
        
        /// <summary>
        /// The <see cref="DateTime"/> associated with the value
        /// </summary>
        ...
        public OpcVariableChangedEvent(MonitoredItem monitoredItem)
        {
            this.Id = monitoredItem.StartNodeId.Identifier;
